...
exportgraphics(fig, 'first_15_QRS_Noise.png', 'Resolution', 200);
% number of pulses
...
exportgraphics(fig, 'all_pulse_ECG_Noise.png', 'Resolution', 150);
...
title('ECG signal with detected QRS complexes');
grid on;
exportgraphics(fig, 'first_15_QRS_pulse_Noise.png', 'Resolution', 150);
