...
% Plot the autoregressive model output with noise
plot(t, ar_output_with_noise, 'r--', 'LineWidth', 1.5);
hold off;

% Set plot title and labels
title('ECG Signal vs Autoregressive Model Output with Noise');
xlabel('Time (seconds)');
ylabel('Amplitude');
legend('ECG Signal', 'AR Model Output with Noise');
